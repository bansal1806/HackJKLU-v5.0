                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td align="center" valign="middle">
                                                        <img src="${siteUrl}/events/HackJKLU.png" alt="HackJKLU" width="160" style="display:inline-block;vertical-align:middle;max-width:160px;height:auto;margin-right:2px;-ms-interpolation-mode:bicubic;image-rendering:high-quality;" />
                                                        ...
                                                        <img src="${siteUrl}/events/JkLU_Logo.png" alt="JKLU" width="75" style="display:inline-block;vertical-align:middle;max-width:75px;height:auto;-ms-interpolation-mode:bicubic;image-rendering:high-quality;" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
