...
export function Events() {
    return (
        <section id="events" className="min-h-screen bg-black flex flex-col items-center justify-center py-20 px-4">
            <h2 className="text-4xl md:text-6xl font-[Cinzel] text-white tracking-[0.2em] mb-20 text-center">Side Events</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {events.map((evt, i) => (
                    ...
                    >
                        ...
                        <span className="inline-block py-1 px-3 bg-white/10 text-xs tracking-widest uppercase rounded-full">{evt.time}</span>
                    </motion.div>
                ))}
            </div>
        </section>
