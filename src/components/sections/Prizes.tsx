...
const domainPrizes = [
  {
    ...
    title: "DOMAIN PRIZE",
    god: "AI & ML",
    role: "Best AI Innovation",
    amount: "7K",
    color: "#00CED1",
    border: "linear-gradient(to bottom right, #00CED1, #008B8B)",
    image: domainSpartan,
  },
  {
    rank: "2",
    title: "DOMAIN PRIZE",
    god: "Security",
    role: "Best Security Hack",
    amount: "7K",
    color: "#32CD32",
    border: "linear-gradient(to bottom right, #32CD32, #006400)",
    image: domainSpartan,
  },
  {
    rank: "3",
    title: "DOMAIN PRIZE",
    god: "Web3",
    role: "Best Blockchain DApp",
    amount: "7K",
    color: "#9370DB",
    border: "linear-gradient(to bottom right, #9370DB, #4B0082)",
    image: domainSpartan,
  },
  {
    rank: "4",
    title: "DOMAIN PRIZE",
    god: "Data",
    role: "Best Data Solution",
    amount: "7K",
    color: "#ff7f50",
    border: "linear-gradient(to bottom right, #ff7f50, #8b0000)",
    image: domainSpartan,
  },
];
...
export default function Prizes() {
  ...
  const domainPrevIndex =
    (domainActiveIndex - 1 + domainPrizes.length) % domainPrizes.length;
  ...
  const handlePrev = () => {
    if (isAnimating) return;
    setActiveIndex(
      (prev) => (prev - 1 + mainPrizes.length) % mainPrizes.length
    );
  };
  ...
  const handleDomainPrev = () => {
    if (isAnimating) return;
    setDomainActiveIndex(
      (prev) => (prev - 1 + domainPrizes.length) % domainPrizes.length
    );
  };
  ...
  return (
    <div
      ref={containerRef}
      className="relative bg-neutral-950 text-neutral-100 min-h-screen h-[100dvh] overflow-hidden selection:bg-yellow-900 selection:text-white pt-20 sm:pt-24 md:pt-32 lg:pt-40 xl:pt-48 pb-16 sm:pb-20 md:pb-24"
    >
        ...
        {flameParticles.map((particle, i) => (
          <motion.div
            ...
            style={{
              ...
              boxShadow:
                "0 0 8px rgba(255, 140, 0, 0.6), 0 0 16px rgba(255, 69, 0, 0.4)",
            }}
            animate={{
              y: ["0vh", "-120vh"],
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div
          ...
          style={{ backgroundColor: "rgba(178, 34, 34, 0.25)" }}
        />
        <div
          className="absolute top-[15%] right-[-5%] w-[40%] h-[40%] rounded-full blur-[80px]"
          style={{ backgroundColor: "rgba(255, 69, 0, 0.18)" }}
        />
        <div
          className="absolute bottom-[15%] left-[-5%] w-[45%] h-[45%] rounded-full blur-[120px]"
          style={{ backgroundColor: "rgba(139, 69, 19, 0.22)" }}
        />
        <div
          className="absolute w-[35%] h-[35%] rounded-full blur-[60px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
          style={{ backgroundColor: "rgba(178, 34, 34, 0.18)" }}
        />

        {/* Additional battlefield fire sources */}
        <div
          className="absolute top-[30%] left-[20%] w-[25%] h-[25%] rounded-full blur-[70px]"
          style={{ backgroundColor: "rgba(255, 140, 0, 0.15)" }}
        />
        <div
          className="absolute bottom-[30%] right-[20%] w-[30%] h-[30%] rounded-full blur-[90px]"
          style={{ backgroundColor: "rgba(160, 82, 45, 0.16)" }}
        />
        ...
        <div
          className="absolute inset-0 bg-gradient-to-t from-amber-900/8 via-transparent to-orange-900/6"
          style={{
            background:
              "linear-gradient(to top, rgba(139, 69, 19, 0.08) 0%, transparent 50%, rgba(255, 140, 0, 0.06) 100%)",
          }}
        />
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(255, 140, 0, 0.04) 0%, rgba(178, 34, 34, 0.06) 50%, rgba(255, 69, 0, 0.04) 100%)",
          }}
          animate={{
            opacity: [0.3, 0.7, 0.3],
            scale: [1, 1.02, 1],
        ...
        >
          <div className="container mx-auto px-3 sm:px-6 md:px-8 py-4 sm:py-8 md:py-12 flex flex-col items-center justify-center h-full">
            ...
            <div className="relative w-full max-w-7xl h-[380px] sm:h-[450px] md:h-[500px] lg:h-[550px] xl:h-[600px] flex items-center justify-center">
              ...
              >
                <img
                  src={arrowLeft}
                  alt=""
                  className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 drop-shadow-[0_0_15px_rgba(212,175,55,0.6)]"
                />
              </button>
              <button
                onClick={handleNext}
              ...
              <div className="relative w-full h-full flex items-center justify-center px-2 sm:px-4 md:px-8 lg:px-12">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <h2
                      className="text-2xl xl:text-3xl 2xl:text-4xl tracking-[0.2em] xl:tracking-[0.25em] 2xl:tracking-[0.3em] mb-2 xl:mb-3"
                    ...
                    <div
                      className="text-5xl xl:text-6xl 2xl:text-7xl font-bold font-baskerville tracking-tighter"
                      style={{
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h2
                  className="text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-[0.1em] sm:tracking-[0.15em] md:tracking-[0.2em] mb-1 sm:mb-2 font-bold"
                  style={{ color: activePrize.color }}
                >
                  {activePrize.title}
                </h2>
                ...
                <div
                  className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-baskerville tracking-tighter"
                  style={{
                    color: activePrize.color,
      ...
      >
        <div className="container mx-auto px-2 sm:px-6 md:px-8 py-4 flex flex-col items-center justify-center h-full">
          <motion.h2
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-[0.1em] sm:tracking-[0.15em] md:tracking-[0.2em] text-[#e8dab2] text-center mb-8 sm:mb-12 drop-shadow-[0_0_15px_rgba(232,218,178,0.3)]"
          >
            DOMAIN PRIZES
          </motion.h2>

          {/* DOMAIN PRIZES GRID - 4 CARDS IN A ROW */}
          <div className="flex flex-wrap xl:flex-nowrap justify-center gap-4 sm:gap-6 w-full max-w-[1600px]">
            {domainPrizes.map((prize, index) => (
              <motion.div
                key={`domain-card-${index}`}
                className="group relative w-[160px] h-[240px] sm:w-[200px] sm:h-[300px] md:w-[240px] md:h-[360px] lg:w-[280px] lg:h-[420px] xl:w-[320px] xl:h-[480px] rounded-xl overflow-hidden cursor-pointer border border-[#d4af37]/30 transition-all duration-500"
              ...
              >
                ...
                <div
                  className="absolute inset-0 bg-cover bg-center transition-all duration-500 ease-out group-hover:blur-[8px] group-hover:scale-110"
                  style={{
                ...
                <div className="absolute inset-2 border border-[#d4af37]/50 rounded-lg pointer-events-none opacity-80" />
                ...
                {/* Default Clean View (Just Name?) or Nothing? Request said "Show content of that" on hover. 
                    Let's show the Title cleanly at bottom by default? Or nothing?
                    Reference image shows clean cards. Let's keep it mostly clean, maybe just a subtle title.
                */}

                {/* Content Reveal on Hover */}
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-75">
                  <h4
                    className="text-2xl sm:text-3xl font-bold mb-2 font-medieval tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] translate-y-4 group-hover:translate-y-0 transition-transform duration-500"
                    style={{ color: prize.color }}
                  >
                    {prize.god}
                  </h4>
                  <p className="text-sm sm:text-base text-neutral-200 font-baskerville mb-3 italic translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-75">
                    {prize.role}
                  </p>
                  <div
                    className="text-4xl sm:text-5xl font-bold font-baskerville tracking-tighter translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-100"
                    style={{
                      color: prize.color,
                      textShadow: `0 0 20px ${prize.color}60`,
                    }}
                  >
                    {prize.amount}
                  </div>
          ...
          <motion.p
            ...
            className="mt-8 text-neutral-500 font-cinzel text-sm tracking-widest uppercase"
          >
            Hover to reveal prizes
          </motion.p>
        </div>
      </motion.section>
    </div>
