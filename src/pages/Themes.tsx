...
export function Themes() {
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden font-cinzel text-[#e8dab2] flex flex-col">
      ...
      {/* Changed justify-center to justify-start with safe top padding to prevent header overlap */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-start w-full max-h-screen pt-24 xs:pt-28 md:pt-32 pb-8 overflow-hidden">
        ...
        <motion.h1
          ...
          // Added landscape-specific height adjustments for text size via style or just standard responsive classes
        ...
        <div
          ...
          style={{
            ...
            transformOrigin: 'top center', // Pivot from top to keep it close to title
            marginTop: '-20px' // Slight pull up to reduce gap if scaling is small
          }}
        >
